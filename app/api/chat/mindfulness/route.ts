  ...
  try {
    ...
    try {
      const response = await generateChatResponse(
        ...
        userId // Pass user ID if available
      )
      ...
      if (lastUserMessage.toLowerCase().includes('breathing')) {
        ...
        fallbackResponse = "I'm here to support your mindfulness journey. Would you like to try a breathing exercise, practice gratitude, or learn about stress management techniques? Let me know how I can help guide your practice today."
      }
